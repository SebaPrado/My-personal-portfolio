...
const Section_3 = () => {
  <div className="expertiseFlexContainer ">
    ...
    <div className="expertiseFlexItems">
      <h4 className="rotacion">Your Back-end Developer</h4>
      <p>
      ...
      <p>
        ...
        (Create, Read, Update, Delete) are implemented and tested using tools
        like{" "}
        <span>
    ...
    <div className="expertiseFlexItems">
      ...
      <p>
        Looking for a reliable fullstack developer to integrate into your team?
        With a focus on finding solutions, I'm here to help you accelerate
        project timelines and enhance productivity, considering I offer both
        achievement alternatives or hour-rate.
      </p>
    </div>
    ...
    <div className="expertiseFlexItems">
      ...
      <p>
        Turn static Figma files into dynamic, fully responsive interfaces. Using
        handcrafted CSS or Js libraries ( FramerMotion , Swiper , tailwind ) , I
        create interactive, visually compelling experiences that retain the
    ...
    <div className="expertiseFlexItems impar">
      ...
      <p>
        ...
        antioxidant secret weapon for staying focused and ensuring your project
        is finished right on schedule.
      </p>
    </div>
  </div>;
};
